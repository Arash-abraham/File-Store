            ...
            <form action="{{ route('admin.menu.update', $menu->id) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select name="target" 
                                ...
                                required>
                            <option value="_self" {{ old('target', $menu->target) == '_self' ? 'selected' : '' }}>همان صفحه</option>
                    ...
                    <div>
                        ...
                        <select name="status" 
                                ...
                                required>
                            <option value="active" {{ old('status', $menu->status) == 'active' ? 'selected' : '' }}>فعال</option>
                            <option value="inactive" {{ old('status', $menu->status) == 'inactive' ? 'selected' : '' }}>غیرفعال</option>
                        </select>
                        @error('status')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <textarea name="description" 
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('description') border-red-500 @enderror">{{ old('description', $menu->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
