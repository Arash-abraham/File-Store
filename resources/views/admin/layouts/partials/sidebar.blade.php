<div class="lg:w-1/4">
    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-24">
        <nav class="space-y-2">
            ...
            <a href="{{route('admin.file-product.index')}}" class="sidebar-item flex items-center p-3 rounded-lg transition-colors" data-section="product-files">
            ...
            <a href="{{ route('admin.tag.index') }}" class="sidebar-item flex items-center p-3 rounded-lg transition-colors" data-section="tags">
                <i class="fas fa-tag w-5 ml-3"></i>
                <span>برچسب‌ها</span>
            </a>
            <a href="{{ route('admin.coupon.index') }}" class="sidebar-item flex items-center p-3 rounded-lg transition-colors" data-section="coupons">
            ...
            <a href="{{route('admin.web-setting.index')}}" class="sidebar-item flex items-center p-3 rounded-lg transition-colors" data-section="settings">
