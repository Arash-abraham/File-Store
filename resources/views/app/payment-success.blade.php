                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 text-right"> <!-- 3 ستون برای عرض بیشتر -->
                        ...
                        <div class="bg-white rounded-lg p-3 shadow-sm">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="font-bold text-green-600">{{ number_format($order->final_amount) }} تومان</span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-1">                            
                            @if($order->discount_amount > 0)
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-green-700 font-semibold text-sm">مبلغ نهایی: {{ number_format($order->final_amount) }} تومان</span>
                                </div>    
                            @endif
                        </div>
                    </div>
