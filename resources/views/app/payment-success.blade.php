        ...
        <div class="success-animation">
            <div class="order-card p-8 md:p-10 text-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-right">
                        ...
                        <div class="bg-white rounded-xl p-4 shadow-sm">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span class="font-bold text-green-600 text-lg">{{ number_format($order->total_amount) }} تومان</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('home') }}" class="btn-primary text-white px-8 py-4 rounded-xl font-semibold text-lg inline-flex items-center justify-center">
