                        ...
                        <div class="bg-white rounded-2xl shadow-sm p-6 mb-6 text-right">
                            ...
                            <div class="space-y-3 text-right">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold text-lg">{{ number_format($finalAmount) }} تومان</span>
                                </div>
                                
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-700">موجودی کیف پول:</span>
                                    <span class="font-bold {{ $walletBalance > 0 ? 'text-green-600' : 'text-gray-600' }}">
                                ...
                                <div class="flex justify-between items-center border-t border-gray-200 pt-3">
                                    ...
                                    <span class="font-bold text-green-600">{{ number_format($walletCoverage) }} تومان</span>
                                </div>
                                @endif
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold text-blue-600">{{ number_format($gatewayAmount) }} تومان</span>
                                </div>
                                @endif
