            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center text-sm text-gray-600">
                    ...
                    <span>موجودی: <span class="font-semibold text-green-600">
                        <?php echo e($wallet->formatted_balance); ?>
                ...
                <div class="flex gap-4">
                    <a href="<?php echo e(route('home')); ?>" class="text-blue-600 hover:text-blue-800 transition-colors" title="صفحه اصلی">
...
</header><?php /**PATH /opt/lampp/htdocs/File-Store/resources/views/layouts/partials/header.blade.php ENDPATH**/ ?>