    ...
    <div class="container mx-auto px-4 py-12">
        <div class="max-w-md mx-auto">
            ...
            <div id="loginForm" class="bg-white rounded-b-xl shadow-lg p-8">
                ...
                <form id="loginFormElement" class="space-y-6" method="POST" action="<?php echo e(route('login')); ?>">
                    <?php echo csrf_field(); ?>
                    <?php if($errors->any()): ?>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <a class="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors" href="<?php echo e(route('login.email')); ?>">
                            <button type="button">
                                <i class="fab fa-google text-red-500 ml-2"></i>
                                <span class="text-sm">Email</span>
                            </button>
                        </a>
                        <a class="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors" href="<?php echo e(route('login.sms')); ?>">
                            <button type="button">
            ...
            <div id="registerForm" class="bg-white rounded-b-xl shadow-lg p-8 hidden">
                ...
                <form id="registerFormElement" class="space-y-6" method="POST" action="<?php echo e(route('register')); ?>">
                    <?php echo csrf_field(); ?>
                    <?php if($errors->any()): ?>
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg mb-4">
                            <ul class="list-disc pr-4">
...
</html><?php /**PATH /opt/lampp/htdocs/File-Store/resources/views/auth/login.blade.php ENDPATH**/ ?>